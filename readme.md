...
```shell script
# Python wrapper to use the octomap data in the planner
pip2 install octomap-python

# To install the C++ octomap library (https://github.com/OctoMap/octomap/wiki/Compilation-and-Installation-of-OctoMap)
...
# To install the octomap server in ROS
